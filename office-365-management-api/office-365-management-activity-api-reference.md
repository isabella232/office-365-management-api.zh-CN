...
- <span data-ttu-id="d7b4d-157">启用因通知发送失败次数过多而被禁用的 Webhook。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-157">Enable a webhook that was disabled because of excessive failed notifications.</span></span>
...
#### <a name="sample-request"></a><span data-ttu-id="d7b4d-194">示例请求</span><span class="sxs-lookup"><span data-stu-id="d7b4d-194">Sample request</span></span>
...
#### <a name="sample-request"></a><span data-ttu-id="d7b4d-217">示例请求</span><span class="sxs-lookup"><span data-stu-id="d7b4d-217">Sample request</span></span>
...
### <a name="pagination"></a><span data-ttu-id="d7b4d-280">分页</span><span class="sxs-lookup"><span data-stu-id="d7b4d-280">Pagination</span></span>
...
|<span data-ttu-id="d7b4d-407">AF10001</span><span class="sxs-lookup"><span data-stu-id="d7b4d-407">AF10001</span></span>|<span data-ttu-id="d7b4d-408">在请求中发送的权限集 ({0}) 不含所需的权限 **ActivityFeed.Read**。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-408">The permission set ({0}) sent in the request did not include the expected permission **ActivityFeed.Read**.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-409">{0} = 访问令牌中的权限集。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-409">{0} = the permission set in the access token.</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-410">AF20001</span><span class="sxs-lookup"><span data-stu-id="d7b4d-410">AF20001</span></span>|<span data-ttu-id="d7b4d-411">缺少参数 {0}。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-411">Missing parameter: {0}.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-412">{0} = 缺少的参数的名称。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-412">{0} = the name of the missing parameter.</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-413">AF20002</span><span class="sxs-lookup"><span data-stu-id="d7b4d-413">AF20002</span></span>|<span data-ttu-id="d7b4d-414">参数类型 {0} 无效。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-414">Invalid parameter type: {0}.</span></span> <span data-ttu-id="d7b4d-415">类型应为 {1}</span><span class="sxs-lookup"><span data-stu-id="d7b4d-415">Expected type: {1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-416">{0} = 无效参数的名称。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-416">{0} = the name of the invalid parameter.</span></span></p></li><li><p><span data-ttu-id="d7b4d-417">{1} = 应采用的类型（int、datetime、guid）</span><span class="sxs-lookup"><span data-stu-id="d7b4d-417">{1} = the expected type (int, datetime, guid).</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-418">AF20003</span><span class="sxs-lookup"><span data-stu-id="d7b4d-418">AF20003</span></span>|<span data-ttu-id="d7b4d-419">提供的到期时间 {0} 设置为过去的日期和时间。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-419">Expiration {0} provided is set to past date and time.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-420">{0} = 在 API 调用中传递的到期时间。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-420">{0} = the expiration passed in the API call.</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-421">AF20010</span><span class="sxs-lookup"><span data-stu-id="d7b4d-421">AF20010</span></span>|<span data-ttu-id="d7b4d-422">在 URL 中传递的租户 ID ({0}) 与访问令牌中传递的租户 ID ({1}) 不一致。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-422">The tenant ID passed in the URL ({0}) does not match the tenant ID passed in the access token ({1}).</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-423">{0} = 在 URL 中传递的租户 ID</span><span class="sxs-lookup"><span data-stu-id="d7b4d-423">{0} = tenant ID passed in the URL</span></span></p></li><li><p><span data-ttu-id="d7b4d-424">{1} = 在访问令牌中传递的租户 ID</span><span class="sxs-lookup"><span data-stu-id="d7b4d-424">{1} = tenant ID passed in the access token</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-425">AF20011</span><span class="sxs-lookup"><span data-stu-id="d7b4d-425">AF20011</span></span>|<span data-ttu-id="d7b4d-426">指定的租户 ID ({0}) 在系统中不存在或已遭删除。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-426">Specified tenant ID ({0}) does not exist in the system or has been deleted.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>   <span data-ttu-id="d7b4d-427">{0} = 在 URL 中传递的租户 ID</span><span class="sxs-lookup"><span data-stu-id="d7b4d-427">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-428">AF20012</span><span class="sxs-lookup"><span data-stu-id="d7b4d-428">AF20012</span></span>|<span data-ttu-id="d7b4d-429">指定的租户 ID ({0}) 未在系统中正确配置。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-429">Specified tenant ID ({0}) is incorrectly configured in the system.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>    <span data-ttu-id="d7b4d-430">{0} = 在 URL 中传递的租户 ID</span><span class="sxs-lookup"><span data-stu-id="d7b4d-430">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-431">AF20013</span><span class="sxs-lookup"><span data-stu-id="d7b4d-431">AF20013</span></span>|<span data-ttu-id="d7b4d-432">在 URL 中传递的租户 ID ({0}) 不是有效的 GUID。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-432">The tenant ID passed in the URL ({0}) is not a valid GUID.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p> <span data-ttu-id="d7b4d-433">{0} = 在 URL 中传递的租户 ID</span><span class="sxs-lookup"><span data-stu-id="d7b4d-433">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-434">AF20020</span><span class="sxs-lookup"><span data-stu-id="d7b4d-434">AF20020</span></span>|<span data-ttu-id="d7b4d-435">指定的内容类型无效。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-435">The specified content type is not valid.</span></span>|
|<span data-ttu-id="d7b4d-436">AF20021</span><span class="sxs-lookup"><span data-stu-id="d7b4d-436">AF20021</span></span>|<span data-ttu-id="d7b4d-437">无法验证 Webhook 终结点{{0})。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-437">The webhook endpoint {{0}) could not be validated.</span></span> <span data-ttu-id="d7b4d-438">{1}</span><span class="sxs-lookup"><span data-stu-id="d7b4d-438">{1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-439">{0} = Webhook 地址。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-439">{0} = webhook address.</span></span></p></li><li><p><span data-ttu-id="d7b4d-440">{1} =“终结点未返回 HTTP 200”</span><span class="sxs-lookup"><span data-stu-id="d7b4d-440">{1} = "The endpoint did not return HTTP 200."</span></span> <span data-ttu-id="d7b4d-441">或“地址必须以 HTTPS 开头”。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-441">or "The address must begin with HTTPS."</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-442">AF20022</span><span class="sxs-lookup"><span data-stu-id="d7b4d-442">AF20022</span></span>|<span data-ttu-id="d7b4d-443">找不到对指定内容类型的订阅。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-443">No subscription found for the specified content type.</span></span>|
|<span data-ttu-id="d7b4d-444">AF20023</span><span class="sxs-lookup"><span data-stu-id="d7b4d-444">AF20023</span></span>|<span data-ttu-id="d7b4d-445">{0} 已禁用订阅。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-445">The subscription was disabled by {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-446">{0} =“租户管理员”或“服务管理员”</span><span class="sxs-lookup"><span data-stu-id="d7b4d-446">{0} = "a tenant admin" or "a service admin"</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-447">AF20030</span><span class="sxs-lookup"><span data-stu-id="d7b4d-447">AF20030</span></span>|<span data-ttu-id="d7b4d-448">必须同时指定（或同时省略）开始时间和结束时间，两者间隔不得超过 24 小时，且开始时间与当前时间的间隔不得超过 7 天。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-448">Start time and end time must both be specified (or both omitted) and must be less than or equal to 24 hours apart, with the start time no more than 7 days in the past.</span></span>|
|<span data-ttu-id="d7b4d-449">AF20031</span><span class="sxs-lookup"><span data-stu-id="d7b4d-449">AF20031</span></span>|<span data-ttu-id="d7b4d-450">nextPage 输入 {0} 无效</span><span class="sxs-lookup"><span data-stu-id="d7b4d-450">Invalid nextPage Input: {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-451">{0} = 在 URL 中传递的下页指示符</span><span class="sxs-lookup"><span data-stu-id="d7b4d-451">{0} = the next page indicator passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-452">AF20050</span><span class="sxs-lookup"><span data-stu-id="d7b4d-452">AF20050</span></span>|<span data-ttu-id="d7b4d-453">指定的内容 ({0}) 不存在。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-453">The specified content ({0}) does not exist.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-454">{0} = 资源 ID 或资源 URL</span><span class="sxs-lookup"><span data-stu-id="d7b4d-454">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-455">AF20051</span><span class="sxs-lookup"><span data-stu-id="d7b4d-455">AF20051</span></span>|<span data-ttu-id="d7b4d-456">使用密钥 {0} 请求获取的内容已到期。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-456">Content requested with the key {0} has already expired.</span></span> <span data-ttu-id="d7b4d-457">无法检索 7 天前的内容。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-457">Content older than 7 days cannot be retrieved.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-458">{0} = 资源 ID 或资源 URL</span><span class="sxs-lookup"><span data-stu-id="d7b4d-458">•    {0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-459">AF20052</span><span class="sxs-lookup"><span data-stu-id="d7b4d-459">AF20052</span></span>|<span data-ttu-id="d7b4d-460">URL 中的内容 ID {0} 无效。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-460">Content ID {0} in the URL is invalid.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-461">{0} = 资源 ID 或资源 URL</span><span class="sxs-lookup"><span data-stu-id="d7b4d-461">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-462">AF20053</span><span class="sxs-lookup"><span data-stu-id="d7b4d-462">AF20053</span></span>|<span data-ttu-id="d7b4d-463">Accept-Language 头中只能显示一种语言。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-463">Only one language may be present in the Accept-Language header.</span></span>|
|<span data-ttu-id="d7b4d-464">AF20054</span><span class="sxs-lookup"><span data-stu-id="d7b4d-464">AF20054</span></span>|<span data-ttu-id="d7b4d-465">Accept-Language 头中的语法无效。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-465">Invalid syntax in Accept-Language header.</span></span>|
|<span data-ttu-id="d7b4d-466">AF429</span><span class="sxs-lookup"><span data-stu-id="d7b4d-466">AF429</span></span>|<span data-ttu-id="d7b4d-467">请求次数过多。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-467">Too many requests.</span></span> <span data-ttu-id="d7b4d-468">方法 = {0}，PublisherId = {1}</span><span class="sxs-lookup"><span data-stu-id="d7b4d-468">Method={0}, PublisherId={1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d7b4d-469">{0} = HTTP 方法</span><span class="sxs-lookup"><span data-stu-id="d7b4d-469">{0} = HTTP Method</span></span></p></li><li><p><span data-ttu-id="d7b4d-470">{1} = 用作 PublisherIdentifier 的租户 GUID</span><span class="sxs-lookup"><span data-stu-id="d7b4d-470">{1} = Tenant GUID used as PublisherIdentifier</span></span></p></li></ul>|
|<span data-ttu-id="d7b4d-471">AF50000</span><span class="sxs-lookup"><span data-stu-id="d7b4d-471">AF50000</span></span>|<span data-ttu-id="d7b4d-472">发生了内部错误。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-472">An internal error occurred.</span></span> <span data-ttu-id="d7b4d-473">请重试请求。</span><span class="sxs-lookup"><span data-stu-id="d7b4d-473">Retry the request.</span></span>|
