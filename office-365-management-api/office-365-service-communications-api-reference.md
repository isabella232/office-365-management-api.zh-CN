...
## <a name="the-fundamentals"></a><span data-ttu-id="d5484-111">基础知识</span><span class="sxs-lookup"><span data-stu-id="d5484-111">The fundamentals</span></span>
...
<span data-ttu-id="d5484-130">**响应头**</span><span class="sxs-lookup"><span data-stu-id="d5484-130">**Response headers**</span></span>
...
## <a name="get-services"></a><span data-ttu-id="d5484-166">获取服务</span><span class="sxs-lookup"><span data-stu-id="d5484-166">Get Services</span></span>
...
||<span data-ttu-id="d5484-226">服务</span><span class="sxs-lookup"><span data-stu-id="d5484-226">Service</span></span>|<span data-ttu-id="d5484-227">说明</span><span class="sxs-lookup"><span data-stu-id="d5484-227">Description</span></span>|
|:-----|:-----|:-----|
...
||<span data-ttu-id="d5484-246">服务</span><span class="sxs-lookup"><span data-stu-id="d5484-246">Service</span></span>|<span data-ttu-id="d5484-247">说明</span><span class="sxs-lookup"><span data-stu-id="d5484-247">Description</span></span>|
|:-----|:-----|:-----|
|<span data-ttu-id="d5484-248">**路径**</span><span class="sxs-lookup"><span data-stu-id="d5484-248">**Path**</span></span>| `/Messages`||
|<span data-ttu-id="d5484-249">**筛选器**</span><span class="sxs-lookup"><span data-stu-id="d5484-249">**Filters**</span></span>|<span data-ttu-id="d5484-250">Workload</span><span class="sxs-lookup"><span data-stu-id="d5484-250">Workload</span></span>|<span data-ttu-id="d5484-251">按 Workload 筛选（String，默认值：all）。</span><span class="sxs-lookup"><span data-stu-id="d5484-251">Filter by workload (String, default: all).</span></span>|
||<span data-ttu-id="d5484-252">StartTime</span><span class="sxs-lookup"><span data-stu-id="d5484-252">StartTime</span></span>|<span data-ttu-id="d5484-253">按 StartTime 筛选（DateTimeOffset，默认值：ge CurrentTime - 7 days）。</span><span class="sxs-lookup"><span data-stu-id="d5484-253">Filter by Start Time (DateTimeOffset, default: ge CurrentTime - 7 days).</span></span>|
||<span data-ttu-id="d5484-254">EndTime</span><span class="sxs-lookup"><span data-stu-id="d5484-254">EndTime</span></span>|<span data-ttu-id="d5484-255">按 EndTime 筛选（DateTimeOffset，默认值：le CurrentTime）。</span><span class="sxs-lookup"><span data-stu-id="d5484-255">Filter by End Time (DateTimeOffset, default: le CurrentTime).</span></span>|
||<span data-ttu-id="d5484-256">MessageType</span><span class="sxs-lookup"><span data-stu-id="d5484-256">MessageType</span></span>|<span data-ttu-id="d5484-257">按 MessageType 筛选（String，默认值：all）。</span><span class="sxs-lookup"><span data-stu-id="d5484-257">Filter by MessageType (String, default: all).</span></span>|
||<span data-ttu-id="d5484-258">ID</span><span class="sxs-lookup"><span data-stu-id="d5484-258">ID</span></span>|<span data-ttu-id="d5484-259">按 ID 筛选（String，默认值：all）。</span><span class="sxs-lookup"><span data-stu-id="d5484-259">Filter by ID (String, default: all).</span></span>|
|<span data-ttu-id="d5484-260">**查询选项**</span><span class="sxs-lookup"><span data-stu-id="d5484-260">**Query-option**</span></span>|<span data-ttu-id="d5484-261">$select</span><span class="sxs-lookup"><span data-stu-id="d5484-261">$select</span></span>|<span data-ttu-id="d5484-262">选择一部分属性。</span><span class="sxs-lookup"><span data-stu-id="d5484-262">Pick a subset of properties.</span></span>|
||<span data-ttu-id="d5484-263">$top</span><span class="sxs-lookup"><span data-stu-id="d5484-263">$top</span></span>|<span data-ttu-id="d5484-264">选择前多少个结果（默认值和最大值：$top = 100）。</span><span class="sxs-lookup"><span data-stu-id="d5484-264">Pick the top number of results (default and max $top=100).</span></span>|
||<span data-ttu-id="d5484-265">$skip</span><span class="sxs-lookup"><span data-stu-id="d5484-265">$skip</span></span>|<span data-ttu-id="d5484-266">跳过的结果数（默认值：$skip = 0）。</span><span class="sxs-lookup"><span data-stu-id="d5484-266">Skip number of results (default: $skip=0).</span></span>|
|<span data-ttu-id="d5484-267">**响应**</span><span class="sxs-lookup"><span data-stu-id="d5484-267">**Response**</span></span>|<span data-ttu-id="d5484-268">“Message”实体列表。</span><span class="sxs-lookup"><span data-stu-id="d5484-268">List of "Message" entities.</span></span>|<span data-ttu-id="d5484-269">“Message”实体包含“Id”(String)、“StartTime”(DateTimeOffset)、“EndTime”(DateTimeOffset)、“Status”(String)、“Messages”（“MessageHistory”实体列表）、“LastUpdatedTime”(DateTimeOffset)、“Workload”(String)、“WorkloadDisplayName”(String)、“Feature”(String)、“FeatureDisplayName”(String) 和“MessageType”（Enum，默认值：all）。</span><span class="sxs-lookup"><span data-stu-id="d5484-269">"Message" entity contains "Id" (String), "StartTime" (DateTimeOffset), "EndTime" (DateTimeOffset), "Status" (String), "Messages" (list of "MessageHistory" entity), "LastUpdatedTime" (DateTimeOffset), "Workload" (String), "WorkloadDisplayName" (String), "Feature" (String), "FeatureDisplayName" (String), "MessageType" (Enum, default: all).</span></span><br/><br/><span data-ttu-id="d5484-270">“MessageHistory”实体包含“PublishedTime”(DateTimeOffset) 和“MessageText”(String)。</span><span class="sxs-lookup"><span data-stu-id="d5484-270">"MessageHistory" entity contains "PublishedTime" (DateTimeOffset), "MessageText" (String).</span></span>|
||||

#### <a name="sample-request"></a><span data-ttu-id="d5484-271">示例请求</span><span class="sxs-lookup"><span data-stu-id="d5484-271">Sample request</span></span>
...
#### <a name="sample-response"></a><span data-ttu-id="d5484-272">示例响应</span><span class="sxs-lookup"><span data-stu-id="d5484-272">Sample response</span></span>
